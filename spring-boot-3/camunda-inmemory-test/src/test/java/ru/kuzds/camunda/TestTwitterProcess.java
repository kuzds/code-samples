...
import ru.kuzds.camunda.rest.ReviewTweetRestApi;
...
class TestTwitterProcess {
    ...
    void testTweetApproved() throws Exception {
        // Prepare data input
        TwitterProcessVariables variables = TwitterProcessVariables.builder()
                .tweet("Hello world")
                .boss("Zeebot")
                .build();
     ...
     */
    @Test
    void testTweetApprovedByRestApi() throws Exception {
